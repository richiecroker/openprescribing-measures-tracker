...
if github_token is None:
    ...
    if res.status_code == 200:
        ...
        if isinstance(data, list):
            ...
            st.dataframe(styled_df, hide_index=True, use_container_width=True, column_config={"github_url": st.column_config.LinkColumn("Github link", display_text="https://github.com/ebmdatalab/openprescribing/blob/main/openprescribing/measures/definitions/(.*?)"), "next_review_months": None})
        else:
